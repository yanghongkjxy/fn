...
func (cl *client) GetRoute(ctx context.Context, app *models.App, route string) (*models.Route, error) {
	...
	err := cl.do(ctx, nil, &r, "GET", "apps", app.Name, "routes", strings.TrimPrefix(route, "/"))
	return &r.R, err
}
